...
-- Resources
ADD JAR ${hiveconf:BIG_BENCH_HDFS_ABSOLUTE_PATH}/${hiveconf:BIG_BENCH_HDFS_QUERY_RESOURCES}/opennlp-maxent-3.0.3.jar;
ADD JAR ${hiveconf:BIG_BENCH_HDFS_ABSOLUTE_PATH}/${hiveconf:BIG_BENCH_HDFS_QUERY_RESOURCES}/opennlp-tools-1.6.0.jar;
...
CREATE TABLE IF NOT EXISTS ${hiveconf:TEMP_TABLE1} (
   s_store_sk     BIGINT, 
   s_store_name   STRING
)
;

INSERT INTO ${hiveconf:TEMP_TABLE1} 
...
CREATE TABLE IF NOT EXISTS ${hiveconf:TEMP_TABLE2} (
   store_ID       STRING,
...
INSERT INTO ${hiveconf:TEMP_TABLE2} 
SELECT
